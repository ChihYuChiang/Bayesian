...
#theta is the correct rate (estimate the correct rate of a student)
...
#Try and error to find the distribution conform to our knoweledge: we think that they will do better than just guessing randomly (theta = 0.25)
